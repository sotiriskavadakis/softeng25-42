...
#### 3.1.3 Use Case 3: Απεικόνιση Στατιστικών
...
**Σημείωση:** Με τον όρο διαχειριστής δεν εννοούμε απαραίτητα κάποιον διαχειριστή της ιστοσελίδας, αλλά και γενικότερα κάποιο λογιστικό στέλεχος της εταιρείας ηλεκτρικής ενέργειας που θέλει να έχει μία εποπτεία για τις επιδόσεις του δικτύου φορτιστών.
