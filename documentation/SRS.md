...
#### 3.1.1 Περίπτωση Χρήσης 1: Δέσμευση και Φόρτιση Οχήματος
...
##### 3.1.1.5 Αναμενόμενη συμπεριφορά
...
#### 3.1.2 Περίπτωση Χρήσης 2: Διαχείριση Δικτύου (Admin)

Ο πάροχος διαχειρίζεται την κατάσταση των φορτιστών και τους τιμοκαταλόγους.

##### 3.1.2.1 Ρόλοι
- Πάροχος (Admin)

##### 3.1.2.2 Προϋποθέσεις
- ✅ Πρόσβαση στο CLI με διαπιστευτήρια διαχειριστή.
...
1. Ο Admin συνδέεται στο περιβάλλον CLI.
2. Εκτελεί εντολή για έλεγχο κατάστασης (health check) των φορτιστών.
3. Εκτελεί εντολή για ενημέρωση της τιμής χρέωσης (kWh) σε συγκεκριμένη γεωγραφική ζώνη.
4. Το σύστημα εφαρμόζει τις αλλαγές και επιστρέφει μήνυμα επιτυχίας.
