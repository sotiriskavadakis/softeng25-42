...
### 3.1.1 Περίπτωση χρήσης 1: Εύρεση φορτιστή και πλοήγηση σε αυτόν
...
#### 3.1.1.5 Προβλεπόμενη συμπεριφορά
...
#### 3.1.1.6 Δεδομένα εξόδου και μετα-συνθήκες
...
#### 3.1.2 Περίπτωση Χρήσης 2: Δέσμευση και Φόρτιση Οχήματος

Ο χρήστης εντοπίζει έναν φορτιστή, τον δεσμεύει και πραγματοποιεί φόρτιση του οχήματός του.

##### 3.1.2.1 Ρόλοι
- Πελάτης (EV Driver)

##### 3.1.2.2 Προϋποθέσεις
- ✅ Ο χρήστης είναι συνδεδεμένος στην εφαρμογή.
- ✅ Υπάρχει καταχωρημένη έγκυρη μέθοδος πληρωμής.
- ✅ Ο φορτιστής είναι λειτουργικός και διαθέσιμος.

##### 3.1.2.3 Περιβάλλον εκτέλεσης
- Smartphone App ή Web Browser.

##### 3.1.2.4 Δεδομένα εισόδου
- Επιλογή φορτιστή (ID).
- Χρόνος δέσμευσης (προαιρετικά).
- Εντολή έναρξης και εντολή λήξης φόρτισης.

##### 3.1.2.5 Αναμενόμενη συμπεριφορά

**Κύρια Ροή:**

1. Ο Χρήστης επιλέγει έναν διαθέσιμο φορτιστή από τον χάρτη.
2. Ο Χρήστης επιλέγει "Δέσμευση".
3. Το σύστημα δεσμεύει τον φορτιστή για συγκεκριμένο χρονικό διάστημα.
4. Ο Χρήστης φτάνει στο σημείο και συνδέει το καλώδιο.
5. Ο Χρήστης επιλέγει "Έναρξη Φόρτισης".
6. Το σύστημα πραγματοποιεί προ-δέσμευση ποσού στην κάρτα του χρήστη.
7. Εφόσον εγκριθεί, ξεκινά η παροχή ρεύματος.
8. Η εφαρμογή εμφανίζει ζωντανά την πρόοδο (kWh, Κόστος).
9. Ο Χρήστης ή το σύστημα (λόγω πλήρωσης μπαταρίας) τερματίζει τη φόρτιση.
10. Το σύστημα υπολογίζει το τελικό κόστος, χρεώνει την κάρτα και αποδεσμεύει το υπόλοιπο ποσό.

**Εναλλακτικές Ροές:**

- ⚠️ **Ακύρωση Δέσμευσης:** Αν ο χρήστης δεν ξεκινήσει τη φόρτιση εντός του χρονικού ορίου, η δέσμευση ακυρώνεται αυτόματα.
- ⚠️ **Ανεπαρκές Υπόλοιπο:** Η φόρτιση διακόπτεται αυτόματα μόλις το κόστος φτάσει το ύψος του προ-δεσμευμένου ποσού.

##### 3.1.2.6 Δεδομένα εξόδου και μετα-συνθήκες

- ✔️ Δημιουργία εγγραφής στο Ιστορικό Φορτίσεων του χρήστη.
- ✔️ Έκδοση ψηφιακής απόδειξης.
- ✔️ Ο φορτιστής χαρακτηρίζεται ξανά ως "Διαθέσιμος".

---

#### 3.1.3 Use case 3: Κράτηση Φορτιστή (Reserve Charger)
...
###### Alternate flows
- **Χειροκίνητη ακύρωση από χρήστη**: Ο χρήστης ακυρώνει την κράτηση πριν από την έναρξη, το σύστημα ελευθερώνει τον φορτιστή και ακυρώνει την προεξόφληση
- **Λήξη χρονικού ορίου (No-show)**: Εάν ο χρήστης δεν φτάσει εντός του ορίου, το σύστημα επαναφέρει την κατάσταση του φορτιστή σε "Διαθέσιμος" και χρεώνει το προβλεπόμενο τέλος
