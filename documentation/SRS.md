...
**Διάγραμμα Λειτουργικών Απαιτήσεων:**
...
actor "Administrator (CPO)" as Admin
actor "Guest User" as Guest

rectangle "EVCharge Manager System" {
  usecase "FR-01: Manage Account" as FR01
  usecase "FR-02: Search Chargers" as FR02
  usecase "FR-03: Reserve Charger" as FR03
  usecase "FR-04: Start/Stop Charging" as FR04
  usecase "FR-05: View Statistics" as FR05
  usecase "FR-06: Dynamic Pricing" as FR06
  usecase "FR-07: View History" as FR07
  usecase "FR-08: CLI Management" as FR08
...
rectangle "External Systems" {
  usecase "Payment Gateway" as Payment
  usecase "Maps Service" as Maps
  usecase "Identity Provider" as Identity
  usecase "Notification Service" as Notify
}
